...
%   $Revision: 1.1.8.3 $  $Date: 2006/05/24 03:33:19 $
...
% the parent should listen for children being removed
 ...
 %It should stop when the image is destroyed                                   
 storeListener(hImage,childRemovedListener);
...
% This function is called if an hImageParent in hFig is
